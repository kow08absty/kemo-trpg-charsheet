 ...
 * @var const カラム配列
 */
const SHEETS_COLUMNS = ['row_id', 'uuid', 'title', 'icon', 'sheet', 'editToken', 'password', 'is_hidden'];
/**
 * @var const カラム定義配列
 */
const SHEETS_COLUMN_SPECS = ['integer primary key', 'text not null', 'text', 'text', 'blob', 'text', 'text', 'boolean'];
